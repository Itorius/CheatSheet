...
// 		private static float[] multipliers = { .25f, .5f, 1f, 1.5f, 2f, 3f, 5f, 10f, 30f };
// 		private static string[] multiplierStrings = { ".25x", ".5x", "1x", "1.5x", "2x", "3x", "5x", "10x", "30x" };
...
// 		{
// 			button = new UIImage(TextureAssets.Item[ItemID.WaterCandle].Value);
