...
// 		private static string[] GodModeStateStrings = { CSText("GodModeDisabled"), CSText("GodModeEnabled") };
...
// 		{
// 			button = new UIImage(TextureAssets.Item[ItemID.JimsWings].Value);
// 			button.onLeftClick += (s, e) => { Enabled = !Enabled; };
// 			Enabled = false;
// 			return button;
// 		}
// 	}
//
// 	internal class GodModeModPlayer : ModPlayer
// 	{
// 		public override bool PreHurt(bool pvp, bool quiet, ref int damage, ref int hitDirection, ref bool crit, ref bool customDamage, ref bool playSound, ref bool genGore, ref PlayerDeathReason damageSource)
// 		{
// 			if (GodMode.Enabled) return false;
