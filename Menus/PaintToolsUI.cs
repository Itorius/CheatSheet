...
// 		{
// 			categories.Clear();
// 			view = new PaintToolsView();
// 			this.mod = mod;
// 			CanMove = true;
// 			Width = view.Width + spacing * 2f;
// 			Height = 35f + view.Height + spacing * 2f;
// 			view.Position = new Vector2(spacing, 55f);
// 			AddChild(view);
//
...
// 			btnSnap.Position = new Vector2(spacing, spacing);
// 			AddChild(btnSnap);
//
// 			var position = btnSnap.Position;
//
// 			Main.instance.LoadItem(ItemID.TrashCan);
// 			Main.instance.LoadItem(ItemID.AlphabetStatueI);
// 			Main.instance.LoadItem(ItemID.AlphabetStatueE);
// 			Main.instance.LoadItem(ItemID.AlphabetStatueW);
// 			Main.instance.LoadItem(ItemID.AlphabetStatueN);
//
// 			
// 			uIImage = new UIImage(TextureAssets.Item[ItemID.TrashCan].Value);
// 			position = position.Offset(btnSnap.Width + spacing, 0);
// 			uIImage.Position = position;
// 			uIImage.onLeftClick += (a, b) => view.RemoveSelectedItem();
// 			uIImage.Tooltip = CSText("DeleteSelection");
// 			AddChild(uIImage);
//
// 			uIImage = new UIImage(TextureAssets.Item[ItemID.AlphabetStatueI].Value);
// 			position = position.Offset(uIImage.Width + spacing, 0);
// 			uIImage.Position = position;
// 			uIImage.onLeftClick += (a, b) => PaintToolsEx.Import(view);
// 			uIImage.Tooltip = CSText("ImportData");
// 			AddChild(uIImage);
//
// 			uIImage = new UIImage(TextureAssets.Item[ItemID.AlphabetStatueE].Value);
// 			position = position.Offset(uIImage.Width + spacing, 0);
// 			uIImage.Position = position;
// 			uIImage.onLeftClick += (a, b) => PaintToolsEx.Export(view);
// 			uIImage.Tooltip = CSText("ExportData");
// 			AddChild(uIImage);
//
// 			uIImage = new UIImage(TextureAssets.Item[ItemID.AlphabetStatueW].Value);
// 			position = position.Offset(uIImage.Width + spacing, 0);
// 			uIImage.Position = position;
// 			uIImage.onLeftClick += (a, b) => PaintToolsEx.OnlineImport(view);
// 			uIImage.Tooltip = "Load Online Schematics Database";
// 			AddChild(uIImage);
//
// 			uIImage = new UIImage(TextureAssets.Item[ItemID.AlphabetStatueN].Value);
// 			position = position.Offset(uIImage.Width + spacing, 0);
// 			uIImage.Position = position;
// 			uIImage.onLeftClick += (a, b) => PaintToolsEx.LoadNextX(view);
...
// 		private static bool submitWait;
//
// 		private void Submit()
// 		{
// 			if (PaintToolsSlot.CurrentSelect == null) return;
...
// 			}
//
// 			if (PaintToolsSlot.CurrentSelect.browserID != 0) return;
// 			if (submitWait)
// 			{
...
// 						client.UploadValuesCompleted += SubmitComplete;
...
// 			if (PaintToolsSlot.CurrentSelect.vote == 1) CheatSheet.instance.paintToolsUI.upVoteButton.ForegroundColor = Color.Gray;
// 			if (PaintToolsSlot.CurrentSelect.vote == -1) CheatSheet.instance.paintToolsUI.downVoteButton.ForegroundColor = Color.Gray;
// 			try
// 			{
// 				using (WebClient client = new WebClient())
// 				{
...
// 						{ "vote", up ? "1" : "-1" },
// 					};
// 					client.UploadValuesCompleted += VoteComplete;
...
// 		{
// 			get { return btnSnap.GetValue<SnapType>(); }
// 		}
//
