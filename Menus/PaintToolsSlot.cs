...
//
// 					if (CurrentSelect.vote == 1) CheatSheet.instance.paintToolsUI.upVoteButton.ForegroundColor = Color.Gray;
// 					if (CurrentSelect.vote == -1) CheatSheet.instance.paintToolsUI.downVoteButton.ForegroundColor = Color.Gray;
// 				}
...
// 		{
// 			Point pos = DrawPosition.ToPoint();
...
// 			if (isSelect) spriteBatch.Draw(TextureAssets.MagicPixel.Value, rectangle, color * scale2);
//
// 			SpriteEffects effects = SpriteEffects.None;
// 			if (stampInfo.bFlipHorizontal) effects |= SpriteEffects.FlipHorizontally;
// 			if (stampInfo.bFlipVertical) effects |= SpriteEffects.FlipVertically;
//
// 			spriteBatch.Draw(texture, DrawPosition, null, Color.White, 0f, Vector2.Zero, Scale, effects, 0f);
//
// 			if (isSelect)
// 			{
// 				b = 0.3f;
