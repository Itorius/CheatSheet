...
// 		internal static float[] LightStrengthValues = { 0, .25f, .5f, 1f };
// 		private static string[] LightStrengthStrings = { CSText("LightHackDisabled"), CSText("LightHack25%"), CSText("LightHack50%"), CSText("LightHack100%") };
//
// 		public static UIImage button;
//
// 		public static UIImage GetButton(Mod mod)
// 		{
// 			button = new UIImage(TextureAssets.Item[ItemID.UltrabrightTorch].Value);
// 			button.Tooltip = LightStrengthStrings[LightStrength];
// 			button.onRightClick += (s, e) => { buttonLogic(false); };
// 			button.onLeftClick += (s, e) => { buttonLogic(true); };
